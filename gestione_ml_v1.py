...
def prevDomani(umMax, umMed, umMin, prec, tempMed, tempMax, tempMin, velMed, velRaff, press, stag):
    with open("./Modelli/PrecDom.pkl", "rb") as file:
        precDom = pickle.load(file) 
    with open("./Modelli/PressDom.pkl", "rb") as file:
        pressDom = pickle.load(file) 
    with open("./Modelli/TempDom.pkl", "rb") as file:
        tempDom = pickle.load(file) 
    with open("./Modelli/UmidDom.pkl", "rb") as file:
        umidDom = pickle.load(file) 
    with open("./Modelli/VentoMedDom.pkl", "rb") as file:
        ventoMedDom = pickle.load(file) 
    with open("./Modelli/VentoRaffDom.pkl", "rb") as file:
...
def prevDopoDomani(umMax, umMed, umMin, prec, tempMed, tempMax, tempMin, velMed, velRaff, press, stag):
    with open("./Modelli/PrecDopDom.pkl", "rb") as file:
        precDopDom = pickle.load(file)
    with open("./Modelli/PressDopDom.pkl", "rb") as file:
        pressDopDom = pickle.load(file) 
    with open("./Modelli/TempDopDom.pkl", "rb") as file:
        tempDopDom = pickle.load(file) 
    with open("./Modelli/UmidDopDom.pkl", "rb") as file:
        umidDopDom = pickle.load(file) 
    with open("./Modelli/VentoMedDopDom.pkl", "rb") as file:
        ventoMedDopDom = pickle.load(file)
    with open("Modelli/VentoRaffDopDom.pkl", "rb") as file:
...
def prevDopoDopoDomani(umMax, umMed, umMin, prec, tempMed, tempMax, tempMin, velMed, velRaff, press, stag):
    with open("./Modelli/PrecDopDopDom.pkl", "rb") as file:
        precDopDopDom = pickle.load(file) 
    with open("./Modelli/PressDopDopDom.pkl", "rb") as file:
        pressDopDopDom = pickle.load(file) 
    with open("./Modelli/TempDopDopDom.pkl", "rb") as file:
        tempDopDopDom = pickle.load(file) 
    with open("./Modelli/UmidDopDopDom.pkl", "rb") as file:
        umidDopDopDom = pickle.load(file) 
    with open("./Modelli/VentoMedDopDopDom.pkl", "rb") as file:
        ventoMedDopDopDom = pickle.load(file)
    with open("Modelli/VentoRaffDopDopDom.pkl", "rb") as file:
